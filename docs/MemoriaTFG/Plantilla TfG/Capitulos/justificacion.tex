...
correo se adopta Resend mediante API HTTP, evitando depender de SMTP en
...
se migr\'o a Brevo y, posteriormente, a Resend.
El dise\~no adaptativo del \texttt{EmailService} ha permitido estas
migraciones sin modificar l\'ogica de negocio, demostrando la
flexibilidad del patr\'on de proveedor desacoplado.
