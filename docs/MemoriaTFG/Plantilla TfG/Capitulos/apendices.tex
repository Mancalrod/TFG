...
\section{1. Administrador: Configuraci\'on inicial}
...
\section{2. Profesor: Creaci\'on de la actividad y el entregable}
...
\section{3. Estudiante: Revisi\'on y entrega}
...
\section{4. Profesor: Correcci\'on y retroalimentaci\'on}
...
\section{5. Estudiante: Consulta de resultados}
