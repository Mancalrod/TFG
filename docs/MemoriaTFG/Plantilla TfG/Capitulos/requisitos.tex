...
\hline
\textbf{Artefacto DAS} & \textbf{Archivo original en TFGProteus/assets} & \textbf{Uso en memoria} \\
\hline
...
\figura{0.90}{\detokenize{../../TFGProteus/assets/ArquitecturaTFG.drawio.png}}{Arquitectura l\'ogica del sistema (DAS)}{fig:das-arquitectura}{}

\figura{0.85}{\detokenize{../../TFGProteus/assets/Diagrama de clases.png}}{Modelo de clases del sistema (DAS)}{fig:das-clases}{}

\figura{0.55}{\detokenize{../../TFGProteus/assets/Diagrama de estado.png}}{Diagrama de estado de actividades (DAS)}{fig:das-estado}{}

\figura{0.85}{\detokenize{../../TFGProteus/assets/Diagrama de navegabilidad (1).png}}{Navegabilidad principal de la interfaz (DAS)}{fig:das-navegabilidad}{}

\figura{0.88}{\detokenize{../../TFGProteus/assets/Autenticacion y Acceso.png}}{Secuencia de autenticaci\'on y acceso (DAS)}{fig:das-seq-auth}{}

\figura{0.88}{\detokenize{../../TFGProteus/assets/Realizar Entrega.png}}{Secuencia de realizaci\'on de entrega (DAS)}{fig:das-seq-entrega}{}

\figura{0.75}{\detokenize{../../TFGProteus/assets/InterfazDeUsuarioTFG-LogueadoComoEstudiante.png}}{Mockup de panel principal de estudiante (DAS)}{fig:das-mock-estudiante}{}

\figura{0.75}{\detokenize{../../TFGProteus/assets/LogueadoComoProfesor.png}}{Mockup de panel principal de profesor (DAS)}{fig:das-mock-profesor}{}
...
\hline
VistaEstudianteDentroDeUnaAsignatura.png & Vista de asignatura desde rol estudiante. \\
\hline
LogueadoComoEstudianteSeleccionandoCheckbox.png & Selecci\'on de entregables por estudiante. \\
\hline
LogueadoComoEstudianteEnCalificaci\'ones.png & Consulta de calificaciones y feedback. \\
\hline
...
\hline
DentroDeCalificacionComoProfesor.png & Vista detallada de correcci\'on. \\
\hline
...
\figura{0.88}{\detokenize{../../TFGProteus/assets/Backend Activity Creation-2026-03-18-161459.png}}{Secuencia de creaci\'on de actividad en backend (DAS)}{fig:das-seq-crear-actividad}{}
...
\figura{0.88}{\detokenize{../../TFGProteus/assets/Evaluacion y Feedback.png}}{Secuencia de evaluaci\'on y feedback (DAS)}{fig:das-seq-evaluacion}{}
...
\figura{0.78}{\detokenize{../../TFGProteus/assets/VistaEstudianteDentroDeUnaAsignatura.png}}{Mockup operativo: estudiante dentro de una asignatura (DAS)}{fig:das-mock-estudiante-asignatura}{}

\figura{0.78}{\detokenize{../../TFGProteus/assets/DentroDeCalificacionComoProfesor.png}}{Mockup operativo: detalle de calificaci\'on como profesor (DAS)}{fig:das-mock-calificacion-profesor}{}
...
\figura{0.70}{\detokenize{../../TFGProteus/assets/EntregaConAlgoPuesto.png}}{Mockup de entrega con archivo adjunto (DAS)}{fig:das-mock-entrega-con-archivo}{}
...
\hline
Administrador & Alta y administraci\'on de identidades/cursos & Mockups \texttt{CrearUsuario.png}, \texttt{CrearCurso.png} & RQF-001 a RQF-004, RQF-021, RQF-022 \\
\hline
Profesor & Dise\~no y publicaci\'on de actividad/entregable & Fig. \ref{fig:das-seq-crear-actividad}, \texttt{Creacion de actividad.png} & RQF-005 a RQF-013, REGN-007 \\
\hline
...
\hline
Profesor/Estudiante & Consulta y trazabilidad de resultados & \texttt{PonerComentarios.png}, \texttt{PaginaEstudiantesProfesores.png} & RQF-020, RQI-005, RQNF-009 \\
\hline
\end{tabular}
\normalsize
...
\figura{0.82}{\detokenize{../../TFGProteus/assets/CU-1.drawio.png}}{Caso de uso representativo CU-1 (DAS)}{fig:das-cu-1}{}

\figura{0.82}{\detokenize{../../TFGProteus/assets/CU-2.drawio.png}}{Caso de uso representativo CU-2 (DAS)}{fig:das-cu-2}{}

\figura{0.82}{\detokenize{../../TFGProteus/assets/CU-3.drawio.png}}{Caso de uso representativo CU-3 (DAS)}{fig:das-cu-3}{}

\figura{0.82}{\detokenize{../../TFGProteus/assets/CU-4.drawio.png}}{Caso de uso representativo CU-4 (DAS)}{fig:das-cu-4}{}
...
\hline
Evaluaci\'on y feedback & Calificaci\'on, comentarios y visibilidad de resultados & Profesor/Estudiante & Completa \\
\hline
...
\hline
RQF-014 a RQF-017 & Secuencia de entrega + estados de mockup & \texttt{EntregaService}, validaciones y versionado & Integraci\'on de entregas y E2E de alumno \\
\hline
