...
\item \textbf{Frontend}: SPA est\'atica servida desde plataforma PaaS.
\item \textbf{Backend}: API REST desplegada como servicio web independiente.
...
\hline
Frontend & React + Vite en PaaS & Renderizado de interfaz, estado de sesi\'on y experiencia por rol. \\
\hline
Backend & Spring Boot (Java 21) en PaaS & Exposici\'on de endpoints, reglas de negocio, seguridad y orquestaci\'on de persistencia. \\
\hline
Persistencia & PostgreSQL gestionado & Almacenamiento transaccional y trazabilidad de datos acad\'emicos. \\
\hline
\end{tabular}
