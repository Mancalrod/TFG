...
La definici\'on del cat\'alogo de requisitos se ha construido a partir del Documento ERS (Especificaci\'on de Requisitos del Sistema), el Documento DAS (Documento de An\'alisis del Sistema), el modelado estructurado y versionado en Proteus, el Product Backlog y Sprint Backlog utilizados en la ejecuci\'on iterativa, y la evidencia emp\'irica obtenida durante pruebas funcionales y de integraci\'on. Esta combinaci\'on evita una especificaci\'on desconectada de la implementaci\'on real.
...
La trazabilidad se gestiona en tres niveles: \textbf{nivel de an\'alisis} con identificador en ERS/Proteus, \textbf{nivel de planificaci\'on} con PBI y sprint asociado, y \textbf{nivel de ejecuci\'on} con m\'odulo software y prueba que lo valida. Esta triple vista permite justificar decisiones con evidencia t\'ecnica.
...
Sobre ese diagn\'ostico, las necesidades de negocio priorizadas fueron reducir la carga administrativa en procesos docentes recurrentes, ofrecer al estudiante un flujo de entrega m\'as guiado y transparente, centralizar evaluaci\'on y feedback con reglas de autorizaci\'on claras, y mejorar la mantenibilidad del sistema y su capacidad de evoluci\'on. Estas necesidades conectan directamente con los bloques funcionales del MVP.
...
Las tablas siguientes recogen las capacidades operativas que debe ofrecer
el sistema al usuario final, separadas en dos bloques para mantener legible
...
La tabla siguiente agrupa las restricciones que condicionan qui\'en puede
ejecutar cada operaci\'on, en qu\'e contexto acad\'emico y bajo qu\'e condiciones.
...
La tabla siguiente resume las condiciones de calidad que debe cumplir
el sistema m\'as all\'a de la funcionalidad visible.
