...
\begin{itemize}
    ...
    \item \textbf{Ingenier\'ia de requisitos y modelado:} Para la gesti\'on de requisitos y la generaci\'on de modelos formales (ERS y DAS) se ha utilizado \textbf{Proteus} (\url{https://personal.us.es/amador/proteus/}), una herramienta especializada en trazabilidad e ingenier\'ia del software.
