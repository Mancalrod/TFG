...
El presente Trabajo Fin de Grado se desarrolla en el \textit{\'ambito} de la gesti\'on acad\'emica universitaria, centrado en el ciclo de vida completo de las actividades evaluables: definici\'on de actividades, publicaci\'on de entregables, realizaci\'on de entregas, evaluaci\'on y retroalimentaci\'on.
...
Desde la perspectiva de la ingenier\'ia del software, el problema a resolver consiste en dise\~nar un sistema especializado que, con recursos acotados, maximice la cobertura funcional del ciclo de entregables, garantizando seguridad por rol, una interfaz de usuario enriquecida que reduzca los errores involuntarios y capacidad de evoluci\'on, sin depender de tareas manuales externas a la plataforma.
...
Para alcanzar este fin, se han definido los siguientes objetivos espec\'ificos. En lugar de un listado telegr\'afico, a continuaci\'on se describen de manera extensiva y verificable, indicando su prop\'osito y la evidencia esperada.
