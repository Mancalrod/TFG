...
\noindent\textbf{Referencias conceptuales:} Criterio MoSCoW (Must/Should/Could/Won't) \cite{moscow_method} y su aplicaci\'on al backlog del proyecto.
...
Cada objetivo se conecta con requisitos del ERS y con entregables t\'ecnicos ejecutados durante los sprints.
