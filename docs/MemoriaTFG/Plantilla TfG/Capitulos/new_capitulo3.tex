...
\section{Estructura del cat\'alogo}
...
\section{Priorizaci\'on y alcance}
...
\section{Trazabilidad requisito-backlog-c\'odigo}
...
\section{Contexto documental de partida (ERS y DAS)}
...
\section{Situaci\'on actual y necesidades de negocio (ERS)}
...
\section{Descomposici\'on en subsistemas (ERS)}
...
\section{Cat\'alogo exhaustivo de requisitos del ERS}
...
\section{Reutilizaci\'on de diagramas y mockups del DAS}
...
\section{Lectura t\'ecnica de los diagramas estructurales del DAS}
...
\section{Flujos operativos del DAS y su encaje en la soluci\'on}
...
\section{Cat\'alogo operativo de casos de uso y cobertura funcional}
...
\section{Matriz ampliada de trazabilidad ERS-DAS-implementaci\'on}
...
\section{Cobertura documental alcanzada}
