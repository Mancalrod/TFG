...
\begin{enumerate}
	\item caracterizaci\'on del escenario \emph{as-is} (actores, procesos, fortalezas y debilidades),
	\item identificaci\'on de brechas operativas y tecnol\'ogicas,
	\item definici\'on del escenario \emph{to-be} con mapeo expl\'icito de aportaciones.
\end{enumerate}
...
\section{Situaci\'on actual (escenario \emph{as-is})}
...
se identifican brechas concretas entre la situaci\'on \emph{as-is}
...
\section{Aportaci\'on realizada (escenario \emph{to-be})}
...
La aportaci\'on funcional incluye:
\begin{itemize}
	\item gesti\'on de cursos, grupos, actividades y entregables en una interfaz unificada,
	\item flujo de entrega con validaciones y control de versiones,
	\item evaluaci\'on y retroalimentaci\'on integradas en el ciclo operativo,
	\item control de acceso por rol (administrador, profesor, estudiante).
\end{itemize}
