...
La cobertura se genera con JaCoCo (Java Code Coverage Library, un marco de trabajo de an\'alisis de c\'odigo abierto para medir c\'omo el c\'odigo fuente es ejercitado por los tests autom\'aticos) durante la fase de test, produciendo informe HTML en
