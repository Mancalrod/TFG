...
\begin{itemize}
	...
	\item capacidad temporal real (600 horas en 5 iteraciones).
\end{itemize}
...
\hline
Won't Have (MVP) & OAuth completo, 2FA integral, notificaciones avanzadas & Se reservan para evoluci\'on por coste de implementaci\'on y validaci\'on. \\
\hline
\end{tabular}
...
\begin{itemize}
	\item autenticaci\'on federada completa (OAuth institucional extensivo),
...
\begin{itemize}
	\item \textbf{Riesgo de sobrealcance funcional}: incorporar m\'as funcionalidades de las asumibles en 600 horas.
