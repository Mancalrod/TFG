...
Por otro lado, el \textbf{Perfil B (Producci\'on)} representa un entorno real de producci\'on comercial no gratuito durante 4 meses de proyecto, basado en tarifas mínimas del proveedor PaaS Render para garantizar alta disponibilidad y persistencia sin restricciones de inactividad. La Tabla~\ref{tab:coste-operativo} muestra la comparativa detallada entre ambos perfiles.
...
\hline
\end{tabular}
\caption{Comparativa de costes de infraestructura según perfil de plataforma}
