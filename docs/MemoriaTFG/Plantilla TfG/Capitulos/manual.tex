...
\begin{itemize}
	...
	\item restricciones de correo saliente en PaaS, mitigadas usando proveedores HTTP (Brevo) para correos transaccionales;
	\item migraci\'on de proveedor de correo transaccional: inicialmente se utiliz\'o SendGrid, pero al finalizar su plan gratuito se migr\'o a Brevo. Se evalu\'o Resend como alternativa, pero su plan gratuito requiere dominio verificado para enviar a destinatarios arbitrarios. El dise\~no del \texttt{EmailService} con patr\'on de proveedor desacoplado permite intercambiar proveedores sin modificar l\'ogica de negocio;
