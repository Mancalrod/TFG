...
\begin{itemize}
	\item \textbf{Uso de APIs de OneDrive y correo}: la integraci\'on con OneDrive permite autorizar el acceso del usuario a su cuenta (OAuth2) y gestionar entregas en su almacenamiento en la nube, mientras que el canal de correo (actualmente operado mediante Resend) soporta procesos como recuperaci\'on de contrase\~na y notificaciones de evaluaci\'on.
...
\begin{itemize}
	...
	\item restricciones de correo saliente en PaaS, mitigadas usando proveedores HTTP (Resend) para correos transaccionales;
	\item migraci\'on de proveedor de correo transaccional: inicialmente se utiliz\'o SendGrid, pero al finalizar su plan gratuito se migr\'o a Brevo y, finalmente, a Resend. El dise\~no del \texttt{EmailService} con patr\'on de proveedor desacoplado permiti\'o realizar ambas migraciones sin modificar l\'ogica de negocio;
