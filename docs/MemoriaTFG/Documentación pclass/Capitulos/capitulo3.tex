...
\section{Paquetes}\label{sec:paquete}
	...
	\subsubsection[Extrayendo archivos de estilo de los .dtx y .ins]{Extrayendo archivos de estilo de los {\protect\ttfamily .dtx} y {\protect\ttfamily .ins}}\label{dtx-extraer}
